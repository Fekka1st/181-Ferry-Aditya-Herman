                ...
                <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                    ...
                    <div class="dataTable-container">
                        <table class="table table-striped dataTable-table" id="table1">
                            <thead>
                                <tr>
                                    <th data-sortable="" style="width: 11.2329%;"><a href="#"
                                            class="dataTable-sorter">Name</a></th>
                                    <th data-sortable="" style="width: 44.5662%;"><a href="#"
                                            class="dataTable-sorter">Email</a></th>
                                    <th data-sortable="" style="width: 17.9909%;"><a href="#"
                                            class="dataTable-sorter">Phone</a></th>
                                    <th data-sortable="" style="width: 15.6164%;"><a href="#"
                                            class="dataTable-sorter">City</a></th>
                                    <th data-sortable="" style="width: 10.5936%;"><a href="#"
