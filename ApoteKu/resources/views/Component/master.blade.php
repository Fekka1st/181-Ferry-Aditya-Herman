...
<html lang="en">
	...
	<head><base href="">
		...
		<link href=" {{asset('/master/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
		<link href=" {{asset('master/assets/plugins/global/plugins.bundle.css')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('master/assets/css/style.bundle.css')}}" rel="stylesheet" type="text/css" />

	</head>

	<body id="kt_body" style="background-image: url({{asset('master/assets/media/patterns/header-bg.png')}})" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
		<!--begin::Main-->
		<!--begin::Root-->
		...
		<script src="{{asset('/master/assets/plugins/global/plugins.bundle.js')}}"></script>
		<script src="{{asset('/master/assets/js/scripts.bundle.js')}}"></script>
		<script src="{{asset('/master/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script>
        @yield('plugin')
	</body>
</html>
