    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    {{-- <a href="index.html"><img src="{{asset('./master/assets/compiled/svg/logo.svg')}}" alt="Logo" srcset=""></a> --}}
                    <h2>APOTEKU</h2>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item  ">
                            <a href="component-alert.html" class="submenu-link">Riwayat Transaksi</a>
                        </li>
                        <li class="submenu-item  ">
                            <a href="component-badge.html" class="submenu-link">Laporan Penjualan</a>
                        </li>
                        <li class="submenu-item  ">
                            <a href="component-badge.html" class="submenu-link">Laporan Stok</a>
                        </li>
                        <li class="submenu-item  ">
                            <a href="component-badge.html" class="submenu-link">Laporan Keuangan</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item  ">
...
@if(auth()->user()->role->nama_role == 'Kasir')
     <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item  ">
                            <a href="component-alert.html" class="submenu-link">Point of Sale</a>
                        </li>
                        <li class="submenu-item  ">
                            <a href="component-badge.html" class="submenu-link">Riwayat Transaksi</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item  ">
                            <a href="component-badge.html" class="submenu-link">Laporan Penjualan Harian</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item  ">
...
<ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item  ">
                            <a href="component-badge.html" class="submenu-link">Laporan Stock</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item  ">
